---
title: 'ETF 定投与择时框架（2024）：估值、趋势与再平衡的组合打法'
description: '长期投资不等于“闭眼买入”。本文用估值分位、趋势过滤与再平衡三件套构建 ETF 投资框架：低估时敢于买、趋势弱时减少动作、组合层面定期再平衡，把“稳”做成方法论。'
category: '股票'
coverImage: 'stocks-etf-timing-and-dca-framework-2024.webp'
keywords: 'ETF,定投,择时,估值分位,趋势过滤,再平衡,资产配置,长期投资,投资框架'
publishDate: '2024-03-09'
tags: ['ETF', '资产配置', '长期投资', '投资框架']
---

## 一、写在前面：把内容写成可复用的投资与交易框架

这篇文章以“ETF 定投与择时框架（2024）：估值、趋势与再平衡的组合打法”为主线，围绕 ETF定投、估值分位与再平衡 展开。目标不是给你一个“观点”，而是给你一套能长期复用的框架：
...
- [how to get stock data](https://blog.itick.org/zh-cn/market-data/how-to-get-stock-data)
- [free stock price api guide](https://blog.itick.org/zh-cn/market-data/free-stock-price-api-guide)
